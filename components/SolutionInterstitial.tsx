...
interface SolutionInterstitialProps {
  onNext: () => void;
}

const SolutionInterstitial: React.FC<SolutionInterstitialProps> = ({ onNext }) => {
  return (
...
export default SolutionInterstitial;
